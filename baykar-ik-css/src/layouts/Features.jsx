...
const Features = () => {
  return (
    <div className="bg-waves">
      <div className="section-container !pb-[96px] lg:!pb-[128px] flex flex-col gap-[32px] lg:gap-[80px]">
        {/* SECTION TEXT */}
        <div className="flex flex-col gap-[32px] text-center lg:text-start">
          ...
          <p className="text-[16px]/[22.4px] lg:text-[18px]/[28.8px]">
            Enim neque massa porta adipiscing elit. Sem libero id faucibus nibh amet dictum pellentesque sed. Eu non turpis risus odio sapien, fames
            sit rhoncus. Nec magna sed interdum sit purus tellus. Et volutpat proin neque placerat at bibendum quam tellus.
          </p>
        </div>
        {/* SECTION CONTENT */}
